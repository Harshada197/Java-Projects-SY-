...
public class main{
	public static void main(String[] args){
		...
		do{ //Make Menu Driven Program
			System.out.println("\n\n-----------Menu-----------\n");
			System.out.println("1.Add Data Entry in List\n(Insert Data in Start)");
			System.out.println("2.Display List");
			System.out.println("3.Insert Data at End");
			System.out.println("4.Insert Data at nth place");
			System.out.println("5.Insert data in middle");
			System.out.println("6.Delete data at first");
			System.out.println("7.Delete data at last");
			System.out.println("8.Delete data at nth place");
			System.out.println("9.Delete data at middle place");
			System.out.println("10.Update data at nth position");
			...
			switch(choice){
				...
				case 3:// Inserting Details at End
					obj.InsertEnd();
					break;
				case 4:// Inserting at nth position
					obj.insert_between();
					break;
			   case 5:// Inserting details in middle of the list
				    obj.insert_middle();
				    break;
			   case 6 : // Delete detail from first position
				    obj.deleteFirst();
				    break;
               case 7: // Delete detailss from last position
                    obj.deleteLast();
                    break;
              case 8 : // Delete details of member present on nth place
                    obj.deleteNth();
                    break;
              case 9 : // Delete details of member present in middle
                    obj.deleteMiddle();
                    break;
              case 10: // Update details of member provided by id
                    obj.updateDetails();
                    break;
				}
